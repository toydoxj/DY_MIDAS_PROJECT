...
function defaultRebar(pos: RebarInput["position"]): RebarInput {
  return { position: pos, top_dia: 25, top_count: 3, bot_dia: 25, bot_count: 3, stirrup_dia: 10, stirrup_spacing: 200, cover: DEFAULT_COVER };
}

export function initSectionRebars(sectName: string, B: number, H: number): SectionRebarInput {
  return { section_name: sectName, B, H, rebars: POSITIONS.map(defaultRebar) };
}
